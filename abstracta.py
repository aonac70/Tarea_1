...
# Una clase abstracta en Python es una clase que no puede ser instanciada directamente, sino que sirve como una plantilla para otras clases. 
# Las clases abstractas pueden contener métodos abstractos(al menos uno), que son métodos declarados pero no implementados en la clase abstracta. 
# Las subclases de una clase abstracta deben proporcionar implementaciones concretas para todos los métodos abstractos definidos en la clase abstracta.
class Alumno(ABC):
